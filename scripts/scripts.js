...
duratinButton = document.getElementById("duration-button");
function changeDuration(){
    let changeDuration = prompt('Please Enter the Duration ');
    document.getElementById('duration-text').innerHTML = changeDuration;
    duration = changeDuration;
    recalculate();
}
duratinButton.addEventListener("click", changeDuration);
